...
import { Brain, MessageSquare, Sparkles, ArrowRight, Zap, Mic } from 'lucide-react';
      ...
      <div className="min-h-[calc(100vh-64px)] flex flex-col items-center justify-center px-6 py-20">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
            {/* Mobile: Voice-first CTA */}
            <Link
              href="/voice"
              className="md:hidden group flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 rounded-xl text-white font-semibold hover:opacity-90 transition-all shadow-lg shadow-purple-500/25"
            >
              <Mic className="w-5 h-5" />
              Start Voice Chat
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </Link>
            {/* Desktop: Memory Cloud CTA */}
            <Link
              href="/memory"
              className="hidden md:flex group items-center gap-2 px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-xl text-white font-semibold hover:opacity-90 transition-all"
            >
